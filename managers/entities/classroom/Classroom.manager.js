...
module.exports = class ClassroomManager {
  ...
  async addResource({ __token, id, resource, res }) {
    ...
    // Validate input
    const validationResult = await this.validators.classroom.addResource({
      id,
      resource,
    });
    if (validationResult) return validationResult;
  ...
  async removeResource({ __token, id, resource, res }) {
    ...
    // Validate input
    const validationResult = await this.validators.classroom.removeResource({
      id,
      resource,
    });
    if (validationResult) return validationResult;
